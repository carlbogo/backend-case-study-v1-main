...
def pytest_configure():
    # Load the full ORM registry after test settings are applied, before collecting
    # any tests. Individual tests must not depend on another test importing the app.
